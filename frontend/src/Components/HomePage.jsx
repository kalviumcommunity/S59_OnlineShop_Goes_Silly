        ...
        <>
            <div>
                ...
                <div className="flex justify-center items-center mb-12">
                    ...
                    <button className="border border-pink-700 w-10 h-10  flex justify-center items-center bg-pink-700 text-white mt-5 rounded-full shadow-md ml-3"><Link to="/UpdateProduct"><img src="../../up-chevron.png" alt="" className="w-3" /></Link></button>
